      ...
      <div class="panel panel-default" height="auto" style="margin-left: 1%;">
        ...
        <!-- Tabbed Layout for Profile Menu -->
          <ul class="nav nav-tabs">
            <li role="presentation" >  <a  href ="#about_user" id ="aboutu"  data-toggle="tab" onclick ="changeToProfile(),setActiveProfileTab(0)">About Me</a></li>
            <li role="presentation"><a href ="#weightlog" id="weight" data-toggle="tab" onclick ="changeToWeightLog(),setActiveProfileTab(1)" >Weight Log</a><li>
            <li role="presentation"><a href ="#foodlog" id="food" data-toggle="tab" onclick ="changeToFoodLog(),setActiveProfileTab(2)" >Food Log</a><li>
             <li role="presentation"><a href ="#exerciselog" id="exercise" data-toggle="tab" onclick ="changeToExLog(),setActiveProfileTab(3)" >Exercise Log</a><li>  
             <li role="presentation"><a href ="#waterlog" id="water" data-toggle="tab" onclick ="changeToWaterLog(),setActiveProfileTab(4)" >Water Log</a><li>            
          </ul>

          <!--User Profile Information Tab-->
          <div id ="about_user" >
            <img src ="<?php echo $row[7]?>" class="img-responsive" id="user_img"/>
            <h3>About Me</h3>
