...
class functions {
 ...
 function loadcss($data){
   ...
   $link ='<link href ="http://localhost/Project-Implementation/'.$data.'" rel="stylesheet" type ="text/css" /><br/>';
   return $link;
 }
 ...
 function loadjs($data){
   ...
   $script ='<script type ="text/javascript" src="http://localhost/Project-Implementation/'.$data.'"></script>';
   return $script;
 }
