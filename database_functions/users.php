...
//register user
function signup($username,$name,$email,$password,$image,$dob,$age,$gender,$weight,$sweight, $weight_unit,$height,$height_unit,$security_question,$security_answer){


    $res =sqlQuery( "INSERT into users (user_name,fullname,email,password,image_content,dob,age,gender,start_weight,current_weight, current_weight_unit,height,height_unit,security_question,security_answer) VALUES('$username','$name','$email','$password','$image','$dob','$age','$gender','$weight','$sweight','$weight_unit','$height','$height_unit','$security_question','$security_answer')");
//  INSERT INTO `users`(start_weight, current_weight, current_weight_unit, height, height_unit, security_question, security_answer) VALUES (97, 97,"kgs",5.4,"feet","what was you mothers maiden name","holden")
